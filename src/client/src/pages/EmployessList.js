...
* actionsEmployess.delete
*	@description CRUD ACTION delete
*	@param ObjectId id - Id employess
*
* actionsEmployess.list
...
class EmployessList extends Component {
  ...
  // Load data on start
  componentWillMount() {
    this.props.actionsEmployess.loadEmployessList();
  }
  ...
  confirmDialogDelete(id) {
    this.props.actionsEmployess.deleteEmployess(this.state.idDelete).then(data => {
      this.props.actionsEmployess.loadEmployessList();
      this.setState({ openDialogDelete: false, idDelete: null });
    });
  }
            ...
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                <TableCell component="th" scope="row">
                  <Link to={"/employesses/" + row._id} key={row._id}>
                    {row._id}
                  </Link>
                </TableCell>
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.EmployessListReducer.listEmployess
  };
}
