...
import com.khachsan.db.khachsan_db.service.RolesService;

import com.khachsan.db.khachsan_db.entity.User;
import com.khachsan.db.khachsan_db.service.UserService;
...
public class UserBaseService {
	...
	public User insert(User obj) {
		...
		String sql = "INSERT INTO `user` (`_id`, `username`, `password`, `employess`,`mail`,`name`,`surname` )	VALUES (:id, :username , :password, :employess,:mail,:name,:surname )";
		SqlParameterSource parameters = new MapSqlParameterSource()
		    .addValue("id", obj.get_id())
			.addValue("employess", obj.getEmployess())
	...
	public User update(User obj, Long id) {
		...
		String sql = "UPDATE `User` SET `employess`,`mail`,`name`,`surname` WHERE `_id`=:id";
		SqlParameterSource parameters = new MapSqlParameterSource()
		    .addValue("id", obj.get_id())
			.addValue("employess", obj.getEmployess())
			.addValue("mail", obj.getMail())
